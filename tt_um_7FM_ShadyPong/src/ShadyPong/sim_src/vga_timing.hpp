#ifndef VGA_TIMING_HPP
#define VGA_TIMING_HPP
...
#elif defined(VGA_640_350_85_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_640_400_70_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_640_400_85_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_640_480_60_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_640_480_73_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_640_480_75_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_640_480_85_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_640_480_100_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_720_400_85_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_768_576_60_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_768_576_72_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_768_576_75_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_800_600_56_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_800_600_60_Hz)
...
#define PLL_CLK_RESETB 1'b1
#define PLL_CLK_BYPASS 1'b0
#elif defined(VGA_1024_768_43_Hz_INTERLACED)
